...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="vx-container h-[72px] flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          <div className="relative group">
            <button className="flex items-center gap-1.5 text-[11px] font-mono tracking-[0.16em] uppercase text-[#c9d2c0] hover:text-[#9dff3f] transition-colors">
              Capabilities
      ...
      {open && (
        <div className="lg:hidden bg-[rgba(5,7,4,0.97)] border-b border-[rgba(255,255,255,0.08)]">
